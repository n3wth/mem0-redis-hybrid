    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(124, 58, 237, 0.5) 0%, rgba(56, 189, 248, 0.3) 50%, transparent 70%)',
            filter: 'blur(60px)',
            left: 'var(--mouse-x)',
            top: 'var(--mouse-y)',
        ...
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(236, 72, 153, 0.4) 0%, rgba(67, 56, 202, 0.2) 50%, transparent 70%)',
            filter: 'blur(80px)',
            right: '-10%',
            bottom: '-10%',
          }}
