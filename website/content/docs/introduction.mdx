...
Add persistent memory to AI applications. Store context in Redis, sync to the cloud, retrieve in milliseconds.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
  <a href="/docs/quickstart" className="block p-6 rounded-lg border border-white/10 hover:border-white/20 transition-colors">
    ...
    <p className="text-gray-400 text-sm">Add memory to Claude Desktop in 2 minutes</p>
  </a>

  <a href="/docs/api/client" className="block p-6 rounded-lg border border-white/10 hover:border-white/20 transition-colors">
...
Recall is an MCP server that gives Claude Desktop persistent memory. Your conversations are stored locally in Redis for instant access and backed up to Mem0's cloud for permanence.
...
- [Discord Community](https://discord.gg/recall)
