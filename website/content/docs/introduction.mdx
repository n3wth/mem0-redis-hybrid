...
>
  <div className="flex items-center">
    <h3 className="text-lg font-medium text-white mt-0 mb-0">AI Intelligence</h3>
    <span className="ml-2 px-2 py-0.5 text-xs font-semibold text-emerald-400 bg-emerald-500/10 rounded-full">NEW</span>
  </div>
