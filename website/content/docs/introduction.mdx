...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
  ...
  <a href="/docs/ai-intelligence" className="block p-6 rounded-lg border border-emerald-500/20 hover:border-emerald-500/40 bg-emerald-500/5 transition-colors">
    <h3 className="text-lg font-medium text-white mb-2">
      AI Intelligence
      <span className="ml-2 text-xs bg-emerald-500/20 text-emerald-400 px-2 py-1 rounded">NEW</span>
    </h3>
    <p className="text-gray-400 text-sm">Semantic search, entities, knowledge graphs</p>
  </a>
