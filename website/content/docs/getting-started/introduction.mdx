...
- Serves frequently accessed memories from cache in <1ms
...
1. **Hot Cache**: Most frequently accessed memories (Redis)
2. **Warm Storage**: Recent or important memories (Mem0)
3. **Cold Storage**: All historical memories (Cloud)
